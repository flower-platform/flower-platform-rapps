...
public: 
	...
	void printCommandDescriptorsAsJson(Print* print) {
		print->print(F("["));
		print->print(F("{\"command\":\"goLeft\", \"parameters\":\"\"}"));
		print->print(F(",{\"command\":\"goFront\", \"parameters\":\"\"}"));
		print->print(F(",{\"command\":\"goBack\", \"parameters\":\"\"}"));
		print->print(F(",{\"command\":\"goRight\", \"parameters\":\"\"}"));
		print->print(F(",{\"command\":\"stop\", \"parameters\":\"\"}"));
		print->print(F("]"));
	}
